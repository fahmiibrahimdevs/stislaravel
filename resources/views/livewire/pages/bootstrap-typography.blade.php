...
<section class="section">
          <x-stisla.section-header title="Typography">
...
<h1>Heading 1</h1>
                ...
                <x-stisla.card title="Text Colors">
<div class="text-primary mb-2">Text Primary</div>
                ...
                <x-stisla.card title="Inline Text Element">
<p>You can use the mark tag to <mark>highlight</mark> text.</p>
                ...
                <x-stisla.card title="Abbreviations">
...
<div class="colors">
                ...
                <x-stisla.card title="Text Block">
...
<div class="display-1">Display 1</div>
                ...
                <x-stisla.card title="Naming a Source">
<blockquote class="blockquote">
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <x-stisla.card title="Unordered List">
<p>Sunt in culpa qui officia deserunt mollit anim id est laborum:</p>
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <x-stisla.card title="Ordered List">
<p>Sunt in culpa qui officia deserunt mollit anim id est laborum:</p>
                    <ol>
                      <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</li>
                      <li>tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</li>
