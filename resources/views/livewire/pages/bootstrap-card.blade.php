<div>
    <section class="section">
        <x-stisla.section-header title="Card">
    ...
    <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <x-stisla.card title="Card Title">
<x-slot name="footer">
                    ...
                    <x-stisla.card title="Card Action Button">
<x-slot name="footer">
...
<x-slot name="header">
                    ...
                    <x-stisla.card title="Footer <code>bg-whitesmoke</code>">
<x-slot name="footer">
...
<x-slot name="header">
                            ...
                            <div class="chocolat-parent">
                                <a href="../assets/img/example-image.jpg" class="chocolat-image"
    ...
    @push('js-libraries')
        ...
        <script src="/assets/modules/jquery-ui-dist/jquery-ui.min.js"></script>
    @endpush
</div>
