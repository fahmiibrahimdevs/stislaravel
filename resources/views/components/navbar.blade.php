                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ route('pages.features-profile') }}" class="dropdown-item has-icon"> <i
                                    class="far fa-user"></i> Profile </a>
                            <a href="{{ route('pages.features-activities') }}" class="dropdown-item has-icon"> <i
                                    class="fas fa-bolt"></i> Activities </a>
                            <a href="{{ route('pages.features-settings') }}" class="dropdown-item has-icon"> <i
